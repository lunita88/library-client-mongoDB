    ...
    <div class="bookAuth1 center">
      <div class="userForm">
        ...
        <div>
          ...
          <input id="isbnGet" name="isbn-get" placeholder="ISBN"></input>
        </div>
      </div>
    </div>`.trim(),
    ...
    getBook: function() { 
      ...
      xhttp.onreadystatechange = function() {
          if(this.readyState==4 && this.status==200) {
                ...
                document.querySelector('[name="imgName"]').src = image;
                document.querySelector('[name="book_img"]').src = image;09
...
deleteBook: function() {
      if(!user.isLoggedIn()) {
        ...
        var isbn = document.getElementById('isbnGet').value;
        console.log(isbn);
           /*if(isbn == ""){
              alert("please check isbn");
        } */
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState==4 && this.status==200) {
               console.log(xhttp.responseText);
               user.exitAuthAndMsg('Book has been deleted .');
              }
...
saveEditBook: function () {
      ...
      if(img.files.length > 0) {
        ...
        console.log("img.files[0]:  " + img.files[0]);
     }
